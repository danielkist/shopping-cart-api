...
#3 - Add one product
curl -X POST -F 'product_id=2034b075-eed2-4fb6-b57d-6ca6ca6eed39' -F 'quantity=1' -H "Authorization: cart-1-062c1ec1-c03f-4e6d-b459-c13fd4832d85" http://localhost:8080/shoppingcart/items
...
curl -X POST -F 'product_id=bceb4f87-7ed0-4f39-98a2-ccb4b672123b' -F 'quantity=5' -H "Authorization: cart-1-062c1ec1-c03f-4e6d-b459-c13fd4832d85" http://localhost:8080/shoppingcart/items
